...
package it.unipd.mtss;  
 ...
 { 
     ...
     public void test9To20(){
        ...
        String[] romanN = {"IX","X","XI","XII","XIII",
     ...
     public void  testInRange21To49(){
        ...
        String[] romanN = {"XXI","XXV","XXIX","XXX",
        "XXXV","XXXVII","XLI","XLIV","XLVI","XLIX"};
        for(int i = 0; i < 10; i++){
            assertEquals(romanN[i],IntegerToRoman.convert(numbers[i]));
        }
     }
     ...
     public void  testInRange50To99(){
        ...
        String[] romanN = {"L","LVII","LX","LXIII",
        "LXIX","LXXII","LXXVIII","LXXXIV","XC","XCIX"};
        for(int i = 0; i < 10; i++){
            assertEquals(romanN[i],IntegerToRoman.convert(numbers[i]));
        }
     }
     ...
     public void  testInRange100To499(){
        ...
        String[] romanN = {"C","CVII","CLVIII","CCXII",
        "CCLXIX","CCCXL","CCCXCVIII","CDXXXII","CDLXXI","CDXCIX"};
        for(int i = 0; i < 10; i++){
            assertEquals(romanN[i],IntegerToRoman.convert(numbers[i]));
        }
     }
     ...
     public void  testInRange500To999(){
        ...
        String[] romanN = {"D","DXXXIX","DXCVI","DCXLIII",
        "DCLXXVII","DCCXI","DCCLXVII","DCCCXLIII","CMXLV","CMXCIX"};
        for(int i = 0; i < 10; i++){
            assertEquals(romanN[i],IntegerToRoman.convert(numbers[i]));
        }
     }
